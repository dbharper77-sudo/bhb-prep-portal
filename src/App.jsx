        ...
        <div className="table-wrap"><table style={{ width: "100%" }}>
          ...
          <tbody>{transitItems.map(s => {
            ...
            return <tr key={s.id}>
              ...
              <td style={{ fontWeight: 600 }}>{s.product_name}{s.removal_order_id && <span style={{ marginLeft: 6, fontSize: 9, padding: "1px 6px", background: "rgba(255,145,0,0.15)", color: "var(--orange)", borderRadius: 4, whiteSpace: "nowrap" }}>📦 {s.removal_order_id}</span>}</td>
        ...
        <div className="table-wrap"><table style={{ width: "100%" }}>
          ...
          <tbody>{allSales.map(s => {
            ...
            return <tr key={s.id}>
              ...
              <td style={{ fontWeight: 600, fontSize: 12 }}>{pname}{stockItem?.removal_order_id && <span style={{ marginLeft: 6, fontSize: 9, padding: "1px 6px", background: "rgba(255,145,0,0.15)", color: "var(--orange)", borderRadius: 4, whiteSpace: "nowrap" }}>📦 {stockItem.removal_order_id}</span>}</td>
      ...
      {activeTab === "sales" && (() => {
        ...
        <div className="table-wrap"><table style={{ width: "100%", tableLayout: "fixed" }}>
          ...
          <tbody>{sales.map(s => {
            ...
            return <tr key={s.id}>
              <td style={{ fontSize: 12 }}>{s.date_sold ? formatShortDate(s.date_sold) : "—"}</td>
              <td style={{ fontWeight: 600, fontSize: 12 }}>{displayName}{stockItem?.removal_order_id && <span style={{ marginLeft: 6, fontSize: 9, padding: "1px 6px", background: "rgba(255,145,0,0.15)", color: "var(--orange)", borderRadius: 4, whiteSpace: "nowrap" }}>📦 {stockItem.removal_order_id}</span>}</td>
