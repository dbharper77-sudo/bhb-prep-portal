...
.asin-hover{position:relative;cursor:pointer}.asin-preview{position:fixed;z-index:9999;pointer-events:none;background:var(--bg-card);border:1px solid var(--border);border-radius:10px;padding:8px;box-shadow:0 10px 40px rgba(0,0,0,0.5)}.asin-preview img{width:150px;height:150px;object-fit:contain;background:#fff;border-radius:6px}
